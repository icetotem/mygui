#ifndef MYGUI_BGFX_RENDER_MANAGER_H_
#define MYGUI_BGFX_RENDER_MANAGER_H_
...
namespace MyGUI
{
	...
	class BgfxRenderManager : public RenderManager, public IRenderTarget
	{
	public:
		BgfxRenderManager();
		...
		static BgfxRenderManager* getInstancePtr()
		{
			return static_cast<BgfxRenderManager*>(RenderManager::getInstancePtr());
		}
...
#endif // MYGUI_BGFX_RENDER_MANAGER_H_
